...
module.exports = (app) => {
  app.directive('googleMap', ['$rootScope', '$http', 'lazyLoadApi', 'parksMapCombine', function($rootScope, $http, lazyLoadApi, parksMapCombine) {
    return {
      restrict: 'CA',
      scope: {
        mapId: '@id',
